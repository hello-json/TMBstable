...
######print window_mappingQuality_arr
######print window_sequencingQuality_arr
#采样获取区间比对质量和测序质量结束
#获取区间插删替比率和测序深度开始
window_depth_arr = []
window_insRatio_arr = []
...
######print window_depth_arr
######print window_insRatio_arr
######print window_delRatio_arr
######print window_subRatio_arr
#获取区间插删替比率和测序深度结束
#获取区间上下文信息开始
...
######print window_SVrepeatRatio_arr
#获取sv区间上下文信息结束
#获取sv区间平均读长开始
...
######print window_SVdepth_arr
######print window_SVinsRatio_arr
######print window_SVdelRatio_arr
######print window_SVsubRatio_arr
#获取区间插删替比率和测序深度结束
###结构切分模块结束
